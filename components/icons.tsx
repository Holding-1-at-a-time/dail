...
export const MegaphoneIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15 7.5 7.5 0 000-15zM21 21L15.803 15.803" /><path strokeLinecap="round" strokeLinejoin="round" d="M15.91 11.662a2.25 2.25 0 01-3.182 0l-3.182-3.182a2.25 2.25 0 010-3.182l3.182-3.182a2.25 2.25 0 013.182 0l3.182 3.182a2.25 2.25 0 010 3.182l-3.182 3.182z" /></svg>
);
...
export const PackageIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10.5 11.25h3M12 15h.008" /><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 7.5h16.5M12 3.75l-3.75 3.75" /></svg>
);
...
export const UserGroupIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226A3 3 0 0118 15.75M10.5 15c0-1.657 1.343-3 3-3m0 0c0-1.657-1.343-3-3-3s-3 1.343-3 3m7.5 4.5l-3.75-3.75m0 0V9m0 4.5l3.75 3.75M3.75 6.17c0-1.657 1.343-3 3-3s3 1.343 3 3m-6 0c0 1.657 1.343 3 3 3s3-1.343 3-3m-6 0h6m-6 6.17c0-1.657 1.343-3 3-3s3 1.343 3 3m-6 0c0 1.657 1.343 3 3 3s3-1.343 3-3m-6 0h6" /></svg>
);
export const CarIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-1.875a3.375 3.375 0 013.375-3.375h9.75a3.375 3.375 0 013.375 3.375v1.875m-17.25 4.5h17.25z" /></svg>
);
export const ArrowRightCircleIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
export const ReceiptPercentIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-12V6.75m0 3V9.75m0 3v.75m0 3v.75M9 18v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V18m-12-9h12v10.5h-12V9z" /></svg>
);
...
export const MagicIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.037-.502.081-.753.132m.002 5.714a2.25 2.25 0 00-.659 1.591L5 14.5M9.75 8.818c-.251.037-.502.081-.753.132m0-5.714c.251-.037.502-.081.753-.132m0 5.714c.251-.037.502-.081.753-.132M9.75 3.104a2.25 2.25 0 00-.659-1.591L5 0M9.75 3.104c.251-.037.502-.081.753-.132m.002 5.714c.251.037.502.081.753.132M5 14.5l4.132 4.132a2.25 2.25 0 003.182 0l4.132-4.132a2.25 2.25 0 000-3.182l-4.132-4.132a2.25 2.25 0 00-3.182 0L5 11.318" /></svg>
);
...
export const OfficeBuildingIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h6M9 11.25h6M9 15.75h6M9 20.25h6" /></svg>
);
export const StripeIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 81 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M63.92 10.375c.34-.34.34-.823 0-1.163-.34-.34-.823-.34-1.163 0l-10.15 10.15c-.34.34-.34.823 0 1.163.34.34.823.34 1.163 0l10.15-10.15Z" fill="currentColor"></path><path d="M80.016 19.34c0-3.183-2.22-6.19-5.11-7.01l-2.46-13.09-3.18.66 2.45 13.01c-3.18-.5-6.36 1.07-7.6 3.9l-2.03 4.79c-.34.82.09 1.74.99 1.95l16.44 3.7c.82.17 1.43-.66.99-1.43L80 19.82v-.48Z" fill="currentColor"></path><path d="M49.27 22.01c0-4.87-3.9-8.77-8.77-8.77-4.87 0-8.77 3.9-8.77 8.77s3.9 8.77 8.77 8.77c4.87 0 8.77-3.9 8.77-8.77Zm-3.18 0c0 3.09-2.5 5.59-5.59 5.59-3.09 0-5.59-2.5-5.59-5.59s2.5-5.59 5.59-5.59c3.09 0 5.59 2.49 5.59 5.59Z" fill="currentColor"></path><path d="M33.88 36h-3.18V.25h3.18V36Z" fill="currentColor"></path><path d="M19.72 20.08v-6.72h2.5c2.4 0 3.99 1.58 3.99 3.99v.09c0 2.24-1.28 3.86-3.82 3.86h-2.67Zm-.88 3.27h3.34c3.99 0 7.1-2.8 7.1-7.27v-.09c0-4.16-2.97-7.1-6.92-7.1h-3.52V36h3.18V23.35Z" fill="currentColor"></path><path d="M13.84 10.375c.34-.34.34-.823 0-1.163-.34-.34-.823-.34-1.163 0L2.53 19.36c-.34.34-.34.823 0 1.163.34.34.823.34 1.163 0l10.15-10.15Z" fill="currentColor"></path></svg>
);
...
export const CloudArrowUpIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M19.5 21h-15a2.25 2.25 0 01-2.25-2.25V7.5A2.25 2.25 0 014.5 5.25h15A2.25 2.25 0 0121.75 7.5v11.25a2.25 2.25 0 01-2.25-2.25z" /></svg>
);
...
export const WrenchScrewdriverIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.474-4.474c-.048-.58-.182-1.193-.344-1.743m-2.4 2.4l.25.25m-.25-.25l-.25-.25m2.15 2.15l-2.15-2.15M3 3l3.031 3.031m9.869-3.031l-3.031 3.031M3 3a2.49 2.49 0 013.522 0l4.586 4.586a2.49 2.49 0 010 3.522L3 18" /></svg>
);
export const UsersIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M5.54 5.214A3.375 3.375 0 002.25 8.584V10.5a3.375 3.375 0 003.29 3.359c.522.036 1.05.074 1.566.12A6.375 6.375 0 018.624 18a6.375 6.375 0 01-3.235-1.002c-.99-.607-1.668-1.716-1.71-2.884M16.5 7.5a4.125 4.125 0 11-8.25 0 4.125 4.125 0 018.25 0z" /></svg>
);
...
export const ChatBubbleLeftRightIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.724.39c-.64.067-1.246.376-1.649.824l-1.423 1.668c-.29.34-.766.34-1.056 0l-1.423-1.668a2.252 2.252 0 01-1.649-.823l-3.723-.39A2.25 2.25 0 013 15.894v-4.286c0-.97.616-1.813 1.5-2.097M14.25 6.75l-4.5 4.5m4.5 0l-4.5-4.5" /></svg>
);
...
export const RefreshIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-3.181-3.182l-3.181-3.182a8.25 8.25 0 00-11.664 0l-3.181 3.182m11.664 0l-3.181 3.183" /></svg>
);
export const BarcodeIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15m3-15v15m3-15v15m3-15v15m3-15v15M21 4.5v15" /></svg>
);

export const ShieldCheckIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-4.5a1.125 1.125 0 011.125 1.125v3.348c0 .297.166.57.429.728l3.41 2.046a1.125 1.125 0 010 1.946l-3.41 2.046a1.125 1.125 0 01-.429.728v3.348a1.125 1.125 0 01-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125v-3.348a1.125 1.125 0 01-.429-.728l-3.41-2.046a1.125 1.125 0 010-1.946l3.41-2.046a1.125 1.125 0 01.429-.728v-3.348a1.125 1.125 0 011.125-1.125h2.25z" />
    </svg>
);

export const ArchiveBoxIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m15 0l-7.5-4.5-7.5 4.5m15 0V5.25A2.25 2.25 0 0018 3H6a2.25 2.25 0 00-2.25 2.25v2.25m15 0H3.75" />
    </svg>
);

export const DocumentMagnifyingGlassIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.5h-8.01a1.5 1.5 0 01-1.5-1.5V5.25a1.5 1.5 0 011.5-1.5h8.01a1.5 1.5 0 011.5 1.5v8.232m-9.046 5.016a5.25 5.25 0 107.424-7.424 5.25 5.25 0 00-7.424 7.424z" />
    </svg>
);

export const PaintBrushIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a2.25 2.25 0 012.245 2.4 3 3 0 001.128 5.78 4.5 4.5 0 00-2.245-8.4 2.25 2.25 0 01-2.4-2.245 3 3 0 00-5.78-1.128 2.25 2.25 0 01-2.4-2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0A15.998 15.998 0 006.62 3.75m1.98 1.98a15.998 15.998 0 013.388-1.62m-5.043-.025a15.998 15.998 0 00-1.622-3.385m5.043.025a2.25 2.25 0 002.245 2.4 3 3 0 011.128 5.78 4.5 4.5 0 00-2.245-8.4 2.25 2.25 0 00-2.4-2.245 3 3 0 01-5.78-1.128 2.25 2.25 0 00-2.4-2.245 4.5 4.5 0 018.4-2.245z" />
    </svg>
);