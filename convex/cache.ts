...
export const serviceDescriptionCache = new ActionCache(api.actionCache, {
...
export const ragQuestionCache = new ActionCache(api.actionCache, {
...
export const productAttributeCache = new ActionCache(api.actionCache, {
...
export const productSuggestionCache = new ActionCache(api.actionCache, {
